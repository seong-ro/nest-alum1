  ...
  return {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "아니요. 본 사이트는 신보 Start-up NEST 17기·18기 졸업 기업이 자발적으로 결성한 비공식 동문 커뮤니티입니다. 운영은 동문 기업 중 하나인 주식회사 워터리아(Water-RIA)가 무료 봉사 형태로 담당합니다. 신용보증기금 공식 사이트는 https://www.kodit.co.kr 입니다.",
        },
      },
      {
        "@type": "Question",
