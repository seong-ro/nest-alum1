...
export async function GET(): Promise<Response> {
  ...
  const text = `# Start-up NEST Alumni 1기

> 신용보증기금 Start-up NEST 17·18기 졸업 기업 동문 커뮤니티 갤러리. 자사 홈페이지·뉴스 기사·보도자료 등 어떤 URL이든 입력하면 매거진 형식의 기업 소개 카드를 자동 생성하여 갤러리에 등록·공유할 수 있는 자발적 참여 기반 커뮤니티 플랫폼.

이 사이트는 신용보증기금이 운영하는 Start-up NEST 보육 프로그램의 17·18기 졸업 기업이 첫 세대로 결성한 동문 커뮤니티(Alumni 1기)입니다. 동문 기업들은 본 갤러리를 통해 서로의 사업 영역을 한 눈에 파악하고 기술 협력·투자 연계·공동 사업 기회를 모색할 수 있습니다.
